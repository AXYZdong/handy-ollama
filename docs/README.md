...
| [7.8 在 Cherry Studio 中使用 Ollama](C7/8.%20在%20Cherry%20Studio%20中使用%20Ollama.md) | Cherry Studio + Ollama     | ✅   |
| [7.9 使用 Obsidian 构建 RAG](C7/9.%20使用%20Obsidian%20构建%20RAG.md) | Obsidian + RAG             | ✅   |
| ...                                                                         | ...                       | ... |
